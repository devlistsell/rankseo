...
<div id="CampaignSubscribersContainer" class="listing-form"
    ...
    <div id="CampaignSubscribersList" class="pml-table-container">
        ...
        getList: function() {
            if (this.list == null) {
                this.list = makeList({
                    ...
                    container: $('#CampaignSubscribersContainer'),
                    content: $('#CampaignSubscribersList')
                });
            }
